...
/**
 * @brief Resuelve una tarea dada una dirección de esta.
 * 
 * @param tarea Tarea a resolver.
 * @param sort Puntero a la estructura.
 * @return Status ERROR en caso de error, OK si no.
 */
Status solve_task_by_task(Sort *sort, Task *tarea);
